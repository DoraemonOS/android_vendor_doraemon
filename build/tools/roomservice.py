...
custom_local_manifest = ".repo/local_manifestsDoraemonOS.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'Quiche')
custom_dependencies = "doraemon.dependencies"
org_manifest = "DoraemonOS-devices"  # leave empty if org is provided in manifest
